...
<head>
    ...
    <body>
      <div class="container">
        <form action="update.php?id=<?php echo $row['id'] ?>" method="post" enctype="multipart/form-data" style="margin: auto;">
          <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Update User <?php echo $row['name']; ?></p>
          <div class="form-row">
              ...
              <span class="text-danger"> <?php if(isset($errors['confirm']))  echo $errors['confirm']; ?></span>
                ...
                <div class="form-row">                
                  <div class="form-group col-lg-6" style="margin-top:8px;">
                    ...
                    <span class="text-danger"> <?php if(isset($errors['room']))  echo $errors['room']; ?></span>
                  </div>
                  <div class="form-group col-lg-6">
              <div class="input-group mt-2">
                <span class="input-group-prepend input-group-text">
                ...
                <input type="number" class="form-control" name="exit" placeholder="Exit" value="<?php echo $row['exit']; ?>">
              </div>
              <span class="text-danger"> <?php if(isset($errors['exit'])) echo $errors['exit']; ?></span>
                </div>
                </div>
                <!-- <div class="form-row">     
